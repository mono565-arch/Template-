            ...
            <div className="border-t border-neutral-200 pt-4 space-y-3">
              ...
              <div className="border-t border-neutral-200 pt-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-xl text-primary-700">{formatCurrency(finalTotal)}</span>
                </div>
              </div>
            </div>
              ...
              {appliedCoupon ? (
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 bg-neutral-100 text-neutral-700 font-semibold text-sm rounded-lg hover:bg-neutral-200 transition-colors"
                  >
                    Apply
                  </button>
                </div>

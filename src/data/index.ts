...
export const categories: Category[] = [
  ...
  { id: '4', name: 'Broast', icon: '🍗' },
  { id: '5', name: 'Drinks', icon: '🥤' },
  { id: '6', name: 'Desserts', icon: '🍰' },
]

// Menu page categories (for tabs) - Pasta removed
export const menuCategories = ['All', 'Pizza', 'Burgers', 'Fries', 'Broast', 'Sandwich', 'Drinks', 'Ice Cream', 'Desserts']
...
export const featuredProducts: Product[] = [
  ...
  },
  {
    ...
    category: 'Pizza',
    sizes: [
      { size: 'Small', price: 1199 },
      { size: 'Medium', price: 1599 },
  ...
  },
  {
    ...
    sizes: [
      ...
      { size: 'Medium', price: 1399 },
      { size: 'Large', price: 1799 },
    ],
  },
  {
    id: '5',
    ...
    sizes: [
      ...
      { size: 'Medium', price: 1699 },
      { size: 'Large', price: 2099 },
    ],
  },
  {
    id: '6',
    ...
    category: 'Pizza',
    sizes: [
      { size: 'Small', price: 1049 },
      { size: 'Medium', price: 1449 },
      { size: 'Large', price: 1849 },
    ],
  },
]

// Full menu products for menu page - Pasta removed

...
import { categories, featuredProducts, reviews, whyChooseUs } from '../data'
...
const Home = () => {
  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-16 sm:py-20 lg:py-28">
            <div className="space-y-6 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <Link to={routes.MENU} className="btn-primary w-full sm:w-auto text-base px-8 py-4">
                  Order Now
                  <FiArrowRight className="w-5 h-5" />
                </Link>
                <Link to={routes.MENU} className="btn-outline w-full sm:w-auto text-base px-8 py-4 border-white/30 text-white hover:bg-white hover:text-neutral-900">
                  View Menu
                </Link>
              </div>
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96">
                ...
                <div className="absolute -top-2 -right-2 bg-white rounded-xl px-4 py-2 shadow-lg">
                  ...
                  <p className="font-bold text-primary-700 text-lg">$12.99</p>
                </div>
                <div className="absolute -bottom-2 -left-2 bg-white rounded-xl px-4 py-2 shadow-lg">
                  ...
                  <p className="font-bold text-secondary-700 text-sm">On orders $25+</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* 4. Why Choose Us - White background */}
      <section className="py-16 sm:py-20 lg:py-24 bg-white">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            title="Why Choose Us"
      ...
      {/* 5. Customer Reviews - Warm background */}
      ...
      {/* 7. Google Maps Placeholder - White background */}
      <section className="py-16 sm:py-20 lg:py-24 bg-white">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle

...
const Contact = () => {
  ...
  return (
    <div className="space-y-16 lg:space-y-24">
      ...
      <section>
        <SectionTitle title="Find Us in Lahore" subtitle="We are located in the heart of Lahore, Pakistan" />
        <div className="w-full rounded-2xl overflow-hidden border border-neutral-200 shadow-sm">
          <div className="h-80 sm:h-96 bg-neutral-100 flex flex-col items-center justify-center gap-4 relative overflow-hidden">
            <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'linear-gradient(#d1d5db 1px, transparent 1px), linear-gradient(90deg, #d1d5db 1px, transparent 1px)', backgroundSize: '40px 40px' }} />

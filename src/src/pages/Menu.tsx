...
const Menu = () => {
  ...
  useEffect(() => {
    ...
    if (categoryFromUrl && menuCategories.includes(categoryFromUrl)) {
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="flex gap-2 mt-auto">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-2.5 bg-neutral-100 text-neutral-700 font-medium text-sm rounded-xl hover:bg-neutral-200 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-neutral-900 font-semibold text-sm rounded-xl hover:bg-primary-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
